# P19 Robotic arm project

To test the project use the following commmands to create a catkin workspace.
...
Clone all projec repositories of the group inside /src directory. Then go back to /arm_ws and build the workspace
